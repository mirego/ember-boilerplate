...
function cacheGoogleFonts({routing, strategies, cacheableResponse, expiration}) {
...
function cacheExternalResources({routing, strategies}) {
  routing.registerRoute(/.*(?:googleapis|gstatic)\.com/, new strategies.StaleWhileRevalidate());
}
