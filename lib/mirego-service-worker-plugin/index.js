...
module.exports = {
  ...
  included(app) {
    ...
    this.app.options['mirego-service-worker-plugin'] = this.app.options['mirego-service-worker-plugin'] || {};

    this.app.options['mirego-service-worker-plugin'].appVersion = this.app.project.pkg.version;
  },
